 ...
 <div style="padding-left: 1em">
  <form action="verify.php" method="post">
   ...
   <select name="currency">
    ...
    <?php if ($cfg_BTX_enabled) {echo '<option '; if ($referred && ($referrer_currency == 'BTX')) {echo 'selected="selected" ';} echo 'value="BTX">BTX (~' . ($cfg_BTX_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
