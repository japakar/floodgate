 ...
 <div style="padding-left: 1em">
  <form action="verify.php" method="post">
   ...
   <select name="currency" required="required">
	...
	<?php if ($cfg_TRX_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'TRX')) {echo 'selected="selected" ';} echo 'value="TRX">TRX (~' . ($cfg_TRX_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
