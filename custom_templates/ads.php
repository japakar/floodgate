...
<iframe sandbox="allow-forms allow-scripts" src="http://traffic2bitcoin.com/ptp2.php?ref=sheshiresat" style="display:block;margin-left:auto;margin-right:auto;height:90px;width:728px" scrolling="no"></iframe>
